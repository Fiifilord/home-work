...
!function(t, e) {
    ...
    }, T = "rtl" === document.documentElement.dir, k = (a = {},
    l = 1,
    {
        set: function(t, e, n) {
    ...
    var Q = {
        ...
        trigger: function(t, e, n) {
            ...
            a ? (d = document.createEvent("HTMLEvents")).initEvent(s, l, !0) : d = new CustomEvent(e,{
                bubbles: l,
                cancelable: !0
            }),
    ...
    var q = {
      ...
      , et = function(t) {
        ...
        n.pause = function(t) {
            t || (this._isPaused = !0),
            V.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (p(this._element),
            this.cycle(!0)),
        ...
        n._slide = function(t, e) {
            var n, i, o, s = this, r = V.findOne(".active.carousel-item", this._element), a = this._getItemIndex(r), l = e || r && this._getItemByDirection(t, r), c = this._getItemIndex(l), u = Boolean(this._interval);
    ...
    var nt = "collapse"
      ...
      , st = function(t) {
        ...
        ,
        n._getConfig = function(t) {
            return (t = s({}, it, t)).toggle = Boolean(t.toggle),
            _(nt, t, ot),
            t
        }
        ,
      ...
      , mt = function(e) {
        ...
        a.hide = function() {
            if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                ...
                Q.trigger(t, "hide.bs.dropdown", e).defaultPrevented || (this._popper && this._popper.destroy(),
                this._menu.classList.toggle("show"),
                this._element.classList.toggle("show"),
        ...
        a._getConfig = function(t) {
            return t = s({}, this.constructor.Default, q.getDataAttributes(this._element), t),
        ...
        i.dataApiKeydownHandler = function(t) {
            if (!(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !at.test(t.key)) && (t.preventDefault(),
            t.stopPropagation(),
            !this.disabled && !this.classList.contains("disabled"))) {
                var e = i.getParentFromElement(this)
                  , n = this.classList.contains("show");
                if ("Escape" === t.key)
                    return (this.matches('[data-bs-toggle="dropdown"]') ? this : V.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
                    void i.clearMenus();
                if (n && "Space" !== t.key) {
        ...
        n._triggerBackdropTransition = function() {
            ...
            if (!Q.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented) {
                ...
                Q.one(this._element, "transitionend", (function() {
                    ...
                    e || (Q.one(t._element, "transitionend", (function() {
      ...
      , It = function(e) {
        ...
        a.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                if (p)
                    (d = s.classList).add.apply(d, p.split(" "));
                if ("ontouchstart"in document.documentElement)
                ...
                if (this.tip.classList.contains("fade")) {
                    var _ = h(this.tip);
                    Q.one(this.tip, "transitionend", g),
                    m(this.tip, _)
                } else
                    g()
            }
        ...
        a.setElementContent = function(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = kt(e, this.config.allowList, this.config.sanitizeFn)),
    ...
    var Rt = "scrollspy"
      ...
      , Ut = function(t) {
        ...
        return n.refresh = function() {
            ...
            V.find(this._selector).map((function(t) {
                var e = d(t)
        ...
        n._activate = function(t) {
            ...
            var e = this._selector.split(",").map((function(e) {
              ...
              , n = V.findOne(e.join(","));
            n.classList.contains("dropdown-item") ? (V.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"),
    ...
    var Wt = function(t) {
        ...
        n._transitionComplete = function(t, e, n) {
            ...
            t.parentNode && t.parentNode.classList.contains("dropdown-menu")) && (t.closest(".dropdown") && V.find(".dropdown-toggle").forEach((function(t) {
                return t.classList.add("active")
            }
            )),
            t.setAttribute("aria-expanded", !0));
    ...
    Q.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(t) {
        t.preventDefault(),
        (L(this, "bs.tab") || new Wt(this)).show()
    }
    )),
    E((function() {
        var t = w();
    ...
    var Ft = {
      ...
      , zt = function(t) {
        ...
        ,
        n._getConfig = function(t) {
            return t = s({}, Yt, q.getDataAttributes(this._element), "object" == typeof t && t ? t : {}),
